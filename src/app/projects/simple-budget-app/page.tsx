...
export const metadata: Metadata = {
  title: "Simple Budget App | Fu Yu",
  description: "Case study of a minimalist Android budget app with local persistence and monthly analytics.",
};

const project = getProjectBySlug("simple-budget-app");

export default function SimpleBudgetPage() {
  ...
  return (
    <PageShell className="space-y-12">
      ...
      <ProjectNavigation current="simple-budget-app" />
    </PageShell>
  );
}
